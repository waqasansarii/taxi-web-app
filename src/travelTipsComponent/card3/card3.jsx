    ...
    return (
        <div>
            <div className='travelTips_cards_div'>
                ...
                <div className='travel_card1' data-aos="zoom-in" data-aos-easing="ease-in-out">
                    <img className='card_img' src={tip3} alt="" />
                    <p className='travel_para1'>Money, Tips</p>
                    <p className='travel_para2'>Top beaches to visit in Jamaica?</p>
...
export default TravelTipsCard3