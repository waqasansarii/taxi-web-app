        ...
        <div className='whoareyou_container'>
            <div className='whoareyou_main_div'>
                <div className='whoareyou_div'>
                    ...
                    <h1 className='whoareWe_head'>Who Are We?</h1>
                    <p className='whoareWe_para'>
                ...
                <div className='whatwedo_div'>
                    ...
                    <h1 className='whoareWe_head2'>What We Do?</h1>
                    {/* <div className='para_div'> */}

                        <p className='whoareWe_para2'>
                ...
                <div className='whychooseus_div'>
                    ...
                    <h1 className='whychooseus_head'>Why Choose Us?</h1>
                    <p className='whychooseus_para'>
